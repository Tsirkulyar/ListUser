<template>
  <div class="body">
    <input type="radio" class="input" name="position" checked />
    <input type="radio" class="input" name="position" />
    <input type="radio" class="input" name="position" />
    <input type="radio" class="input" name="position" />
    <input type="radio" class="input" name="position" />
    <main class="carousel">
      <div v-for="photo in album" :key="photo.id">
        <MyPhoto :photo="photo" class="item"/>
      </div>
    </main>
  </div>
</template>
...
import MyPhoto from '../components/UI/MyPhoto.vue'
